...
_Senales encontradas: T1(cross-indication)=25 | T2(subpoblacion)=4 | T3(outcome inesperado)=28 | T4(hidden gems)=123 | T6(temporal)=6 | T7(contradicciones)=12 | T8(kg-convergence)=12 | T9(pleiotropia)=48_
...
El scan revela un campo en transición: mientras que los pilares metabólicos (metformina, GLP-1, dieta) se consolidan como consenso, existe una erosión de la confianza en terapias hormonales clásicas (spironolactona, letrozol) reflejada en la caída de replicación post-2021 [T6]. El patrón global indica un desplazamiento hacia la medicina de precisión basada en el fenotipo (BMI y etnia) y la exploración de vías no canónicas de control glucémico. Destaca la señal robusta de los inhibidores de SGLT2 [T1], que emerge como la oportunidad farmacológica más consistente y menos explotada frente a los GLP-1, ya mainstream.

## Señales prioritarias para investigar

1. **Inhibidores de SGLT2:** Es la señal más potente y genuinamente nueva (88% favorable, score 7.442). A diferencia de la metformina, que actúa en la señalización celular, los SGLT2 reducen la carga glucémica sistémica mediante glucosuria, disminuyendo la hiperinsulinemia sin riesgo de hipoglucemia. Esto podría romper el círculo vicioso de estimulación de células teca por insulina. **Confirmación:** RCT multicéntrico comparando SGLT2 vs Metformina en pacientes con PCOS y BMI >30, midiendo específicamente niveles de testosterona libre y tasa de ovulación.

2. **Melatonina:** Presenta una consistencia alta (83%) y un mecanismo plausible más allá del sueño: la protección contra el estrés oxidativo folicular y la modulación de la señalización de la LH. Aparece en [T1] y se correlaciona con subpoblaciones específicas en [T2b]. **Confirmación:** Estudio de dosis-respuesta evaluando la calidad ovocitaria en ciclos de FIV, comparando melatonina sola vs combinada con antioxidantes clásicos.

3. **Ciclos de Transferencia de Embriones Congelados (NC-FET/MNC-FET):** Aunque son "hidden gems" [T4], el N es masivo (>3,000 participantes), lo que sugiere un impacto clínico real. La hipótesis es que evitar la estimulación ovárica agresiva reduce la inflamación endometrial y la preeclampsia en PCOS. **Confirmación:** Análisis prospectivo comparando tasas de complicaciones placentarias entre ciclos naturales vs artificiales en pacientes con PCOS severo.

## Hipótesis mecanísticas emergentes

1. **Sinergia Etnia-Metabolismo:** Si la respuesta superior en subpoblaciones iraníes y chinas [T2b] no es sesgo de publicación, sino una diferencia en la sensibilidad a andrógenos o arquitectura de receptores GLUT4, entonces los inhibidores de SGLT2 [T1] mostrarán una eficacia significativamente mayor en estas etnias que en caucásicas. Testable mediante un estudio de farmacogenómica comparativo. (Combina [T1] + [T2b]).

2. **Eje Inflamación-Cardiovascular:** Si el uso de cromo y crocina [T9] mejora marcadores cardiovasculares e inflamatorios independientemente de la pérdida de peso, entonces existe una vía de señalización pleitrópica que reduce la resistencia a la insulina vía mitigación de estrés oxidativo y no solo por control glucémico. Testable mediante medición de citoquinas proinflamatorias (IL-6, TNF-α) antes y después de tratamiento con cromo en pacientes no obesas. (Combina [T9] + [T8]).

## Señales que son probablemente ruido

- **Cangfu Daotan / Dingkun Pill:** Ruido por sesgo regional y falta de mecanismo molecular transparente. Un solo estudio [T4] con N alto no compensa la ausencia de replicación independiente.
- **L-carnitina:** Señal débil. Aunque favorable, el mecanismo es demasiado genérico (metabolismo lipídico) y no aborda la patología endocrina central del PCOS.
- **GLP-1 / Liraglutide:** No es ruido, pero es redundante. Ya es consenso que los análogos de GLP-1 funcionan en obesidad/insulinoresistencia; su "señal" aquí es solo una confirmación de lo ya establecido.
- **Spironolactona:** La caída drástica en replicación post-2021 [T6] sugiere que los efectos positivos iniciales estaban sobreestimados o eran placebo, perdiendo valor como señal emergente.
...
### [T4] natural cycle-frozen embryo transfer (nc-fet)
- Estudios: 1 | Favorables: 1 | Tasa favorable: 100% | N medio: 3873 | Rareza: 0.63 | **Score: 7.522**
...
### [T4] programmed cycle-frozen embryo transfer (pc-fet)
- Estudios: 1 | Favorables: 1 | Tasa favorable: 100% | N medio: 3873 | Rareza: 0.63 | **Score: 7.522**
