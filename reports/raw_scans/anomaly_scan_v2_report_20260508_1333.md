...
El scan revela un campo en transición: mientras que los pilares del consenso (metformina, GLP-1, cambios de estilo de vida) muestran una saturación de evidencia o una convergencia hacia la optimización del paciente obeso, emergen señales disruptivas en el manejo glucémico y metabólico. Destaca la fuerte señal de los **SGLT2 inhibitors** (88% favorable) como una alternativa potente a la metformina, y la persistencia de la **melatonina** como modulador endocrino. El análisis de KG confirma que gran parte de la "novedad" reportada en algunos papers es en realidad ruido sobre el eje insulina-obesidad-PCOS (ya establecido), pero identifica un vacío crítico de evidencia directa en la conexión **Microbiota $\rightarrow$ Resistencia a la Insulina $\rightarrow$ PCOS**, sugiriendo que el mecanismo exacto de la disbiosis sobre la sensibilidad insulínica en PCOS sigue siendo una caja negra.

## Señales prioritarias para investigar

1. **SGLT2 Inhibitors:** Es la señal más robusta y menos "mainstream" en guías clínicas actuales para PCOS. A diferencia de la metformina, actúan vía glucosuria independiente de la insulina, lo que podría romper el círculo vicioso de hiperinsulinemia $\rightarrow$ hiperandrogenismo sin los efectos gastrointestinales de la biguanida. Aparece en T1 con alta consistencia. **Validación:** RCT comparativo (SGLT2 vs Metformina) midiendo específicamente la reducción de andrógenos libres y tasa de ovulación.
2. **Melatonina:** Presenta una señal favorable (83%) y es biológicamente plausible debido a que el PCOS cursa con disfunción del eje circadiano y estrés oxidativo folicular. No es un tratamiento estándar, lo que le otorga novedad. **Validación:** Estudio de dosis-respuesta evaluando la calidad del ovocito y la regularidad del ciclo en pacientes no obesas.
3. **Hormone Replacement Therapy (HRT) / Artificial Cycle en FET:** Aunque es un solo estudio (T4), el N es masivo ($\sim$8,300), lo que le da un peso estadístico superior a muchos RCTs pequeños. Sugiere que la preparación endometrial artificial optimiza el outcome reproductivo en PCOS más que los ciclos naturales. **Validación:** Meta-análisis de cohortes prospectivas comparando tasas de implantación en ciclos naturales vs. artificiales específicamente en PCOS.

## Hipótesis mecanísticas emergentes

1. **Eje Microbiota-Insulina-PCOS:** Si la disbiosis intestinal induce resistencia a la insulina mediante la translocación de LPS (endotoxemia metabólica), entonces la modulación selectiva de la microbiota reducirá la hiperinsulinemia antes de afectar el peso corporal, mejorando la tasa de ovulación. Testable mediante un estudio de trasplante de microbiota fecal en modelos animales de PCOS. (Combina T1-Probióticos con T8-KG Convergence).
2. **Sinergia SGLT2-Andrógenos:** Si la reducción de la carga glucémica renal vía SGLT2 disminuye la demanda de insulina pancreática, entonces se observará una caída en la producción de andrógenos en las células teca independientemente de la pérdida de peso. Testable midiendo niveles de testosterona libre en pacientes con SGLT2 que no presentan pérdida de peso significativa. (Combina T1 con T8).

## Señales que son probablemente ruido

- **Sinergias regionales (Iranian/Chinese):** Las señales en T2b probablemente reflejan un sesgo de publicación regional o protocolos de estudio locales más que una susceptibilidad biológica étnica real.
- **Medicina Tradicional China (Cangfu Daotan, Dingkun Pill, Zishen Yutai):** Señales T4 con 100% de favorabilidad pero basadas en un solo estudio cada una. Sin un mecanismo molecular claro y con alta probabilidad de sesgo de selección, son irrelevantes hasta que haya replicación independiente.
- **SGLT2/GLP-1 como "novedad" en obesidad:** Cualquier señal que correlacione simplemente "Obeso $\rightarrow$ GLP-1 $\rightarrow$ Mejora" es ruido, ya que es el mecanismo conocido de estos fármacos en cualquier patología metabólica, no es específico de PCOS.
- **Espironolactona (T6/T7):** La caída de favorabilidad post-2021 sugiere que la literatura está corrigiendo la sobreestimación de su eficacia en el control sistémico del síndrome, limitándola a sus efectos cosméticos (hirsutismo).
