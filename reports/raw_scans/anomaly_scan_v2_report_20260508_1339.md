...
## Resumen ejecutivo
El scan revela un campo en transición: la mayoría de las señales detectadas (T8, T1-GLP1/Liraglutide, T2b-Insulin Resistance) son redundantes y confirman el consenso establecido sobre el eje insulina-andrógenos. Sin embargo, emerge un patrón crítico de "estancamiento" en terapias convencionales (T6: caída de eficacia percibida en espironolactona y letrozol post-2021) frente a un auge de intervenciones metabólicas agresivas. La señal más disruptiva y genuinamente nueva es la de los **inhibidores de SGLT2**, que presentan una consistencia del 88% en resultados favorables con una cobertura de literatura aún baja (23 papers), sugiriendo una ventana de oportunidad terapéutica antes de que se conviertan en consenso.

## Señales prioritarias para investigar

1. **Inhibidores de SGLT2 (SGLT2i):** Es la señal más robusta y novedosa. A diferencia de la metformina, que actúa en la sensibilidad hepática/muscular, los SGLT2i inducen glucosuria y reducen la carga glucémica sistémica sin afectar la secreción de insulina de forma primaria. Esto podría romper el círculo vicioso de hiperinsulinemia $\rightarrow$ estimulación de células teca sin los efectos secundarios gastrointestinales de la metformina. Aparece en T1 con alta consistencia. **Confirmación:** RCT comparativo SGLT2i vs Metformina evaluando específicamente niveles de testosterona libre y tasa de ovulación.

2. **Terapia de Ciclo Artificial / HRT en FET (Frozen Embryo Transfer):** Aunque aparece en T4 con un solo estudio, el $N$ es masivo ($>8,000$ participantes), lo que le otorga una potencia estadística superior a muchos RCTs. Sugiere que la manipulación del entorno endometrial mediante ciclos artificiales optimiza la tasa de implantación y reduce complicaciones gestacionales en pacientes con PCOS, superando los ciclos naturales modificados. **Confirmación:** Estudio multicéntrico comparando resultados perinatales entre ciclos naturales vs. artificiales en cohortes PCOS.

3. **L-Carnitina:** Presenta una señal favorable del 80% y, aunque hay meta-análisis (2022), su integración en la práctica clínica es baja. Su interés radica en la optimización de la $\beta$-oxidación mitocondrial, atacando la disfunción metabólica desde la eficiencia energética celular y no solo desde la señalización de la insulina. **Confirmación:** Estudio de biomarcadores de estrés oxidativo y función mitocondrial en ovario antes y después de suplementación.

## Hipótesis mecanísticas emergentes

1. **Sinergia Etnia-Metabolismo en Respuesta a Inositoles/Metformina:** Si la susceptibilidad genética de las poblaciones iraníes y chinas (T2b) modula la expresión de transportadores de glucosa o la sensibilidad del receptor de insulina, entonces estas subpoblaciones responderán a dosis menores de sensibilizadores metabólicos con mayor tasa de ovulación. Testable mediante genotipado de genes *INSR* y *SLC2A4* en pacientes que respondieron favorablemente en los estudios de T2b. (Combina T1 + T2b).

2. **Eje SGLT2i $\rightarrow$ Reducción de Inflamación Visceral $\rightarrow$ Recuperación de SHBG:** Si la glucosuria inducida por SGLT2i reduce la inflamación crónica de bajo grado más eficazmente que la restricción calórica, entonces observaremos un aumento más rápido de la SHBG hepática y una consecuente caída de andrógenos libres. Testable mediante medición de citoquinas proinflamatorias (IL-6, TNF-$\alpha$) y niveles de SHBG en un brazo de SGLT2i vs. dieta cetogénica. (Combina T1 + T2b-Obese + T9).

## Señales que son probablemente ruido

- **Melatonina y GLP-1/Liraglutide:** Ruido por saturación. Con $>80$ y $>60$ papers respectivamente, ya son consenso o están en fase de implementación; no aportan novedad científica.
- **Cangfu Daotan / Dingkun Pill / Zishen Yutai:** Ruido por sesgo regional y falta de replicación. Son señales T4 (un solo estudio) con mecanismos no plausibles molecularmente y alta probabilidad de sesgo de publicación en medicina tradicional china.
- **T8 (Metformina $\rightarrow$ IR $\rightarrow$ PCOS):** Ruido computacional. El grafo confirma una conexión que ya es el dogma central de la endocrinología reproductiva desde hace décadas.
- **Spironolactone (T6/T7):** La caída en la tasa de éxito post-2021 probablemente no sea una pérdida de eficacia del fármaco, sino un cambio en los criterios de selección de pacientes o una mayor rigurosidad en los endpoints de los estudios modernos.
